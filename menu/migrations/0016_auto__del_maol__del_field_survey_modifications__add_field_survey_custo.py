...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Maol'
        db.delete_table(u'menu_maol')

        # Deleting field 'Survey.modifications'
        db.delete_column(u'menu_survey', 'modifications')

        # Adding field 'Survey.customerComments'
        db.add_column(u'menu_survey', 'customerComments',
    ...
    def backwards(self, orm):
        # Adding model 'Maol'
        db.create_table(u'menu_maol', (
            ('flavor', self.gf('django.db.models.fields.CharField')(max_length=200)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'menu', ['Maol'])

        # Adding field 'Survey.modifications'
        db.add_column(u'menu_survey', 'modifications',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Survey.customerComments'
        db.delete_column(u'menu_survey', 'customerComments')
