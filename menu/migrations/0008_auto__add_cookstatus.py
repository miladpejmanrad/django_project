...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CookStatus'
        db.create_table(u'menu_cookstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cook_name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('current_order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Order'], null=True, blank=True)),
        ))
        db.send_create_signal(u'menu', ['CookStatus'])


    def backwards(self, orm):
        # Deleting model 'CookStatus'
        db.delete_table(u'menu_cookstatus')
