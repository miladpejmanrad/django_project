...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SplitOrder.container'
        db.alter_column('menu_splitorder', 'container_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['menu.SplitOrderContainer']))

    def backwards(self, orm):

        # Changing field 'SplitOrder.container'
        db.alter_column('menu_splitorder', 'container_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['menu.SplitOrderContainer']))
    ...
    models = {
        ...
        'menu.order': {
            ...
            'drinks': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['menu.DrinkOrder']", 'symmetrical': 'False'}),
            'freebie_eligible': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu_items': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['menu.MenuItem']", 'symmetrical': 'False'}),
        ...
        'menu.splitorder': {
            ...
            'container': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'default': 'None', 'blank': 'True', 'to': "orm['menu.SplitOrderContainer']"}),
            'drinks': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['menu.DrinkOrder']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu_items': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['menu.MenuItem']", 'symmetrical': 'False'}),
