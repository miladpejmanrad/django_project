...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.alaki'
        db.add_column(u'menu_ad', 'alaki',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ad.alaki'
        db.delete_column(u'menu_ad', 'alaki')
    ...
    models = {
        ...
        u'menu.ad': {
            'Meta': {'object_name': 'Ad'},
            'advertisement': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'alaki': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '8', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'menu.adminmenu': {
