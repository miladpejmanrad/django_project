...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Ad'
        db.delete_table(u'menu_ad')

        # Adding model 'Advertisement'
        db.create_table(u'menu_advertisement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'menu', ['Advertisement'])


    def backwards(self, orm):
        # Adding model 'Ad'
        db.create_table(u'menu_ad', (
            ('alaki', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('advertisement', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'menu', ['Ad'])

        # Deleting model 'Advertisement'
        db.delete_table(u'menu_advertisement')
