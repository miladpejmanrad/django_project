...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.tikchen'
        db.delete_column(u'menu_order', 'tikchen')

        # Adding field 'Order.KitchenStaff'
        db.add_column(u'menu_order', 'KitchenStaff',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.tikchen'
        db.add_column(u'menu_order', 'tikchen',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Order.KitchenStaff'
        db.delete_column(u'menu_order', 'KitchenStaff')
    ...
    models = {
        ...
        u'menu.order': {
            'KitchenStaff': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
