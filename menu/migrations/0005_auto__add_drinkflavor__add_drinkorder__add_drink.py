...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('menu_drinkorder', (
            ...
            ('flavor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['menu.DrinkFlavor'])),
        ))
    ...
    models = {
        ...
        'menu.drinkorder': {
            ...
            'flavor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['menu.DrinkFlavor']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'menu.menuitem': {
        ...
        'menu.order': {
            ...
            'drinks': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['menu.DrinkOrder']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu_items': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['menu.MenuItem']"}),
            ...
            'table_number': ('django.db.models.fields.IntegerField', [], {}),
            'tikchen': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '64', 'null': 'True'}),
            'timestamp_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'tip': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2', 'default': "'0.00'"}),
