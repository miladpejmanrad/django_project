...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.order'
        db.add_column(u'menu_notification', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Order'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.order'
        db.delete_column(u'menu_notification', 'order_id')
