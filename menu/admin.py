...
from menu.models import Category, MenuItem, Order, SplitOrder, Ad, SplitOrderContainer, Allergen, AdminMenu, Notification, Drink, DrinkFlavor, DrinkOrder, CookStatus, Survey
